...
const setStorage = (storage, value) => if(save_allowed)localStorage.setItem(storage, value)
const getStorage = storage => if(save_allowed) localStorage.getItem(storage)
